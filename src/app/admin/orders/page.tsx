...
import { getOrders, confirmOrder } from "@/action/order";
...
export default function AdminOrdersPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-center text-gray-800">Order</h1>
      ...
      {popupOrder && (
        <div className="fixed top-6 left-1/2 z-50 transform -translate-x-1/2 bg-white shadow-lg rounded-lg border border-green-400 px-6 py-4 flex flex-col items-center animate-fade-in transition-all">
          ...
          <div className="text-sm text-gray-700 mb-1">
            <strong>Customer:</strong> {popupOrder.customer_name || "N/A"}
          </div>
          <div className="text-sm text-gray-700 mb-1">
