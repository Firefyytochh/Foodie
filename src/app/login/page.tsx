  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image src="/images/food-background.png" alt="Food background" fill className="object-cover" priority />
        ...
        <div className="w-full max-w-md space-y-4">
          ...
          <div className="pt-4">
            ...
            <Link href="/landingpage">
              <Button className="w-full bg-orange-500 hover:bg-orange-600 text-white py-4 text-lg font-semibold rounded-full shadow-lg transition-all duration-200 hover:shadow-xl">
                Log In
              </Button>
            </Link>
